...
<script type="text/html" id="userbar">
    ...
    {{#  } else if(d.id=='2') { }}
    <a class="layui-btn layui-btn-xs layui-btn-disabled"> <i class="layui-icon">&#xe642;</i>不可编辑</a>
    <shiro:hasRole name="admin">
    <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="assignUser"><i class="layui-icon">&#xe613;</i>分配用户</a>
    </shiro:hasRole>
    {{#  } else { }}
    ...
    {{#  } else { }}
    <a class="layui-btn layui-btn-xs" lay-event="able"><i class="fa fa-circle-o"></i>&nbsp;启用</a>
    {{#  } }}
